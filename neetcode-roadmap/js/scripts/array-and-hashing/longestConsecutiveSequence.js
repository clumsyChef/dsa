...
const longestConsecutiveSequence = () => {
	console.log(main.solution_1([100, 4, 200, 1, 3, 2]));
	console.log(main.solution_1([0, 3, 7, 2, 5, 8, 4, 6, 0, 1]));
	console.log(main.solution_1([1, 2, 0, 1]));
	console.log(main.solution_1([4, 0, -4, -2, 2, 5, 2, 0, -8, -8, -8, -8, -1, 7, 4, 5, 5, -4, 6, 6, -3]));
};
